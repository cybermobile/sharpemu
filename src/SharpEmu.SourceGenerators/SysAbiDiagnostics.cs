...
public static class SysAbiDiagnostics
{
    ...
    public static readonly DiagnosticDescriptor InvalidHandlerSignature = new(
        ...
        "Method '{0}' must be a static, non-generic method returning void/int/uint/long/ulong and taking no parameters, a single CpuContext parameter, or a CpuContext followed by int/uint/long/ulong or [GuestCString] string parameters",
        Category,
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
