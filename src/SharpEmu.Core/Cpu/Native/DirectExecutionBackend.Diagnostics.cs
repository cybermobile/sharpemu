...
public sealed partial class DirectExecutionBackend
{
	...
	{
		public RecentImportTraceEntry[] Entries { get; } = new RecentImportTraceEntry[64];
		public int Count { get; set; }
		public int WriteIndex { get; set; }
	}

	[ThreadStatic]
	private static RecentImportTraceBuffer? _threadRecentImportTrace;
	...
	private void RecordRecentImportTrace(
		...
		ulong arg2)
	{
		var buffer = _threadRecentImportTrace ??= new RecentImportTraceBuffer();
	...
	{
		var buffer = _threadRecentImportTrace;
